...
cv::Mat createIPM(cv::Mat& inputImage, Point2f vanishingPoint)
{
    float height=inputImage.rows;
    float width=inputImage.cols;
    
    
    trapeziumCoordinates trapCoordinates = createFourPointsForIPM(vanishingPoint.x, vanishingPoint.y);
    
    // The 4-points at the input image
    vector<Point2f> origPoints;
    origPoints.push_back( Point2f(trapCoordinates.point1[0][0]/trapCoordinates.point1[3][0], trapCoordinates.point1[1][0]/trapCoordinates.point1[3][0]) );
    origPoints.push_back( Point2f(trapCoordinates.point4[0][0]/trapCoordinates.point4[3][0], trapCoordinates.point4[1][0]/trapCoordinates.point4[3][0]) );
    origPoints.push_back( Point2f(trapCoordinates.point3[0][0]/trapCoordinates.point3[3][0], trapCoordinates.point3[1][0]/trapCoordinates.point3[3][0]) );
    origPoints.push_back( Point2f(trapCoordinates.point2[0][0]/trapCoordinates.point2[3][0], trapCoordinates.point2[1][0]/trapCoordinates.point2[3][0]) );
    ...
    if(inputImage.channels() == 3)
        cvtColor(inputImage, inputImgGray, CV_BGR2GRAY);
    else
        //        cvtColor(inputImage, inputImgGray, CV_BGR2GRAY);
        inputImage.copyTo(inputImgGray);
    
    // Process
    clock_t begin = clock();
    ipm.applyHomography( inputImage, outputImg );
    clock_t end = clock();
    double elapsed_secs = double(end - begin) / CLOCKS_PER_SEC;
    printf("%.2f (ms)\r", 1000*elapsed_secs);
    Mat inputtedPointsImage = inputImage.clone();
    ipm.drawPoints(origPoints, inputtedPointsImage );
    
    return outputImg;
}

cv::Mat createIPMOfRightSideLane(cv::Mat& inputImage, trapeziumCoordinates trapCoordinates)
{
    float height=inputImage.rows;
    float width=inputImage.cols;
    ...
    //    float height2 = image.size.height;
    
    // The 4-points at the input image
    vector<Point2f> origPoints;
    origPoints.push_back( Point2f(trapCoordinates.point1[0][0]/trapCoordinates.point1[3][0], trapCoordinates.point1[1][0]/trapCoordinates.point1[3][0]) );
    origPoints.push_back( Point2f(trapCoordinates.point4[0][0], trapCoordinates.point4[1][0]) );
    origPoints.push_back( Point2f(trapCoordinates.point3[0][0], trapCoordinates.point3[1][0]) );
    origPoints.push_back( Point2f(trapCoordinates.point2[0][0]/trapCoordinates.point2[3][0], trapCoordinates.point2[1][0]/trapCoordinates.point2[3][0]) );
    ...
    IPM ipm( cv::Size(240, height), cv::Size(240, height), origPoints, dstPoints);
    ...
    //    imshow("inputImage", inputtedPointsImage);
    //    waitKey();
    
    return outputImg;
}

cv::Mat createIPMOfRightSideLaneRobust(cv::Mat &inputImage, trapeziumCoordinates trapCoordinates)
{
    float height=inputImage.rows;
    float width=inputImage.cols;
    ...
    //    imshow("inputImage", inputtedPointsImage);
    //    waitKey();
    //    imshow("inputImageRightSide", inputtedPointsImage);
    
    return outputImg;
}

cv::Mat createIPMOfLeftSideLaneRobust(cv::Mat &inputImage, trapeziumCoordinates trapCoordinates)
{
    float height=inputImage.rows;
    float width=inputImage.cols;
    ...
    ipm.drawPoints(origPoints, inputtedPointsImage );
    //
    //    imshow("inputImageLeftSide", inputtedPointsImage);
    //    waitKey();
